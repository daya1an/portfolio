        ...
        <div className="hidden md:flex items-center gap-1">
          {navigationData.links.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className={`relative px-3 py-2 text-xs font-display tracking-wider transition-colors duration-200 ${
            ...
            <div className="flex flex-col p-4 gap-2">
              {navigationData.links.map((link) => (
                <a
                  ...
                  className={`px-4 py-3 text-sm font-display tracking-wider rounded-md transition-colors ${
                    activeSection === link.href
